...
f4:	dw 'Sort.com',00AH,00H ; null terminated string
f5:	dw 'Search140.com',00AH,00H ; null terminated string
...
begin:
	...
	MVI B,1		; put the address of string in registers B and C
